  ...
  return (
    <>
      <Helmet>
        ...
        <meta name="title" content="Cloud 9 Asperger's/ASD Foundation || About Us" />
        <meta name="description" content="Hello and welcome to the site of the Cloud 9 Children’s Foundation! We are a support organisation that works on both the national and regional level in New Zealand to help children and teenagers who have Asperger’s Syndrome. We also aim to assist those who help children with Asperger’s Syndrome such as the child’s family and carers, teachers and professionals. An important first step in helping children is increasing the awareness of the syndrome in New Zealand. We run programs and activities aimed at lifting the profile of Asperger’s Syndrome in the community, as well as assisting children in their daily social interaction with others." />

        {/* Open Graph / Facebook */}
        <meta property="og:type" content="website" />
        <meta property="og:url" content="http://localhost:5173/" />
        <meta property="og:title" content="Cloud 9 Asperger's/ASD Foundation || About Us" />
        <meta property="og:description" content="Hello and welcome to the site of the Cloud 9 Children’s Foundation! We are a support organisation that works on both the national and regional level in New Zealand to help children and teenagers who have Asperger’s Syndrome. We also aim to assist those who help children with Asperger’s Syndrome such as the child’s family and carers, teachers and professionals. An important first step in helping children is increasing the awareness of the syndrome in New Zealand. We run programs and activities aimed at lifting the profile of Asperger’s Syndrome in the community, as well as assisting children in their daily social interaction with others." />
        ...
        <meta property="twitter:title" content="Cloud 9 Asperger's/ASD Foundation || About Us" />
        <meta property="twitter:description" content="Hello and welcome to the site of the Cloud 9 Children’s Foundation! We are a support organisation that works on both the national and regional level in New Zealand to help children and teenagers who have Asperger’s Syndrome. We also aim to assist those who help children with Asperger’s Syndrome such as the child’s family and carers, teachers and professionals. An important first step in helping children is increasing the awareness of the syndrome in New Zealand. We run programs and activities aimed at lifting the profile of Asperger’s Syndrome in the community, as well as assisting children in their daily social interaction with others." />
