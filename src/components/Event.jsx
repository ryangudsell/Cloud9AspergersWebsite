  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:title" content={`Cloud 9 Asperger's/ASD Foundation || ${event?.title.rendered}`} />
        <meta property="og:description" content={`Hello and welcome to the site of the Cloud 9 Children’s Foundation! ${stripHTMLTags(event?.excerpt.rendered)}`} />
        ...
        <meta property="twitter:title" content={`Cloud 9 Asperger's/ASD Foundation || ${event?.title.rendered}`} />
        <meta property="twitter:description" content={`Hello and welcome to the site of the Cloud 9 Children’s Foundation! ${stripHTMLTags(event?.excerpt.rendered)}`} />
